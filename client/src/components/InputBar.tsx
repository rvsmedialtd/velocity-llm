    ...
    return (
        <form onSubmit={onSubmit} className="p-6">
            <div className="max-w-4xl mx-auto">
                <div className="relative flex items-center bg-theme-secondary rounded-xl border border-theme-primary focus-within:border-[#01953f] transition-colors">
                    <div className="flex items-center pl-4">
                        <button
                            type="button"
                            className="p-2 text-theme-tertiary hover:text-[#01953f] transition-colors"
                        >
                    ...
                    <input
                        ...
                        disabled={disabled}
                        className="flex-1 px-4 py-4 bg-transparent focus:outline-none text-theme-primary placeholder:text-theme-tertiary text-lg disabled:cursor-not-allowed disabled:opacity-50"
                    />
